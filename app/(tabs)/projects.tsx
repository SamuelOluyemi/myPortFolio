    ...
    <>
      ...
      >
        <style>{`
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .project-text {
              ...
              margin-bottom: 0.75rem; color: #040404;
            }
          `}</style>
        ...
        <Text className="project-text">
          This is the Projects tab. Here I can showcase my work, share case
          studies, and provide links to my GitHub repositories or live demos.
          Highlight the projects I'm most proud of and give visitors a sense
          of my skills and experience.
          <br />
          I'd consider including a mix of personal projects, open-source
          contributions, and professional work. For each project, I can
          provide a brief description, the technologies used, and any notable
          challenges I overcame. This is my chance to demonstrate my
          passion for development and the impact of my work.
        </Text>
      </div>
