...
import { Hero, About, Contact, Footer } from "@/components/sections";
...
// Scroll to section if navigated with section param (e.g. from portfolio tab)
  useEffect(() => {
    if (section) {
      setTimeout(() => {
        document
          .getElementById(section as string)
